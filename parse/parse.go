...
func (p *Parse) noPrefixParseFnError() {
...
func (p *Parse) peekPrecedence() int {
...
func (p *Parse) curPrecedence() int {
...
func (p *Parse) parseInfixExpression(left ast.Expression) ast.Expression {
